...
const App = () => (
  <>
	  ...
	  <CookieConsent
		  ...
		  expires={150}
	  >Ce site utilise des cookies pour assurer le bon fonctionnement des procédures et améliore l'expérience de l'utilisation d'applications en ligne.</CookieConsent>
  </>
)
